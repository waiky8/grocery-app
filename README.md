...
To convert the code to android, I used **buildozer**, running on **linux emulator (ubuntu)**. Word of caution, it takes around 30 mins to convert so make sure your code is in decent shape first.
